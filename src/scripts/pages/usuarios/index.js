  ...
  usuarios.forEach((f) => {
    ...
    linha.innerHTML = `
      ...
      <td class="text-center">
          <button class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Visualizar Usuario" onclick="visualizarUsuario('${
            f.idPessoa
          }', '${f.idUsuario}')"><img src="../../assets/View.png"></button>
          <button class="btn btn-warning" data-toggle="tooltip" data-placement="top" title="Editar Usuario" onclick="editarUsuario('${
            f.idPessoa
          }', '${f.idUsuario}')"><img src="../../assets/Edit.png"></button>
          <button class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="Excluir Usuario" onclick="excluirUsuario('${
            f.idUsuario
...
document.addEventListener("submit", async function (event) {
  ...
  try {
    const resposta = await fetch(
      "http://localhost:5164/BlueMoon/Usuarios/Search",
      {
        method: "POST",
