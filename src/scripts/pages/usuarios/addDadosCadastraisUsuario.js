...
IMask(document.getElementById("inputTelefoneFisico"), {
  mask: [{ mask: "(00) 0000-0000" }, { mask: "(00) 00000-0000" }],
});
IMask(document.getElementById("inputTelefoneJuridico"), {
  mask: [{ mask: "(00) 0000-0000" }, { mask: "(00) 00000-0000" }],
});

IMask(document.getElementById("inputCEPFisico"), {
  mask: "00000-000",
});
IMask(document.getElementById("inputCEPJuridico"), {
  mask: "00000-000",
});
